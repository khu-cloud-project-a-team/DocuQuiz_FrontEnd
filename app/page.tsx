    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4">
      <Card className="w-full max-w-md shadow-lg border-0">
        ...
        <CardContent className="grid gap-4">
          <Button variant="outline" className="w-full h-12 relative" asChild>
            <Link href="/dashboard"> {/* 실제론 로그인 로직 후 이동 */}
          ...
          <Button variant="outline" className="w-full h-12 bg-[#FEE500] hover:bg-[#FEE500]/90 text-black border-none" asChild>
             <Link href="/dashboard">
